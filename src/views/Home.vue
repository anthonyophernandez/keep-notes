  ...
  <div class="relative w-full h-full">
    <header class="w-full h-16">
      <div class="flex items-center justify-between w-full h-full border-b border-gray-700">
        <button class="flex items-center justify-center w-10 h-10 ml-5 rounded hover:bg-gray-600 hover:bg-opacity-25 focus:outline-none focus:bg-gray-600 focus:bg-opacity-25" @click="isMenuDisplayed = !isMenuDisplayed">
    ...
    <aside class="fixed inset-y-0 left-0 mt-16" :class="(isMenuDisplayed) ? 'w-64' : 'w-20'">
      <div class="mt-2">
    ...
    <main class="fixed inset-0 px-2 mt-16 overflow-y-auto" :class="(isMenuDisplayed) ? 'ml-64' : 'ml-20'">
      <div class="flex items-center w-full max-w-xl h-12 px-2 mx-auto mt-2 border border-gray-700 rounded-lg">
        <input class="w-full bg-transparent text-white placeholder-gray-600" type="text" placeholder="Take a note...">
        <!-- New List
        <button class="flex items-center justify-center w-10 h-10 ml-2 rounded hover:bg-gray-600 hover:bg-opacity-25 text-gray-600 hover:text-white focus:outline-none">
          <svg xmlns="http://www.w3.org/2000/svg" class="w-8 h-8 stroke-current icon icon-tabler icon-tabler-checkbox" viewBox="0 0 24 24" stroke-width="1.5" fill="none" stroke-linecap="round" stroke-linejoin="round">
            <path stroke="none" d="M0 0h24v24H0z"/>
      ...
      <div class="grid grid-cols-1 gap-3 mt-2">
        <div class="relative flex flex-col w-full max-w-xl h-full mx-auto border border-gray-700 rounded-lg" v-for="index in 14" :key="index">
          ...
          <button class="absolute top-0 right-0 flex items-center justify-center w-8 h-8 mt-1 mr-1 rounded-full hover:bg-gray-600 hover:bg-opacity-25 text-gray-600 hover:text-white focus:outline-none">
          ...
          <div class="w-full h-full px-4">
            <h2 class="text-base text-white font-bold">Title #{{ index }}</h2>
            <div class="mt-2">
          ...
          <div class="flex w-full h-12 mb-1 px-2">
