    ...
    <main class="fixed inset-0 px-2 mt-16 overflow-y-auto" :class="(isMenuDisplayed) ? 'ml-64' : 'ml-20'">
      <div class="relative flex flex-col w-full max-w-xl h-auto mx-auto mt-2 border border-gray-700 rounded-lg">
        ...
        <div class="flex items-center justify-between w-full h-10 mt-2 mb-1 px-2">
          ...
          <button class="w-20 h-8 rounded hover:bg-gray-600 hover:bg-opacity-25 text-gray-600 hover:text-white focus:outline-none">Close</button>
        </div>
      </div>
      <div class="grid gap-3 mt-2" :class="(isDisplayedGrid) ? 'xl:grid-cols-3 md:grid-cols-2 sm:grid-cols-1' : 'grid-cols-1'">
